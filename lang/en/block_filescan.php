...
// Table
$string['table:header:text_check'] = 'Has Text';
$string['table:header:title_check'] = 'Has Title';
$string['table:header:lang_check'] = 'Has Language';
$string['table:header:outline_check'] = 'Has Outline';
